...
$("#currentHour").text(moment().format("28th February 2021, 09:17:35 a"));

setInterval(function () {
  $("#currentHour").text(moment().format("Do MMMM YYYY, h:mm:ss a"));
}, 1000);
...
function updateByTheHour() {
  ...
  $(".time-block").each(function () {
    var blockHour = parseInt($(this).attr("id")[i]);
